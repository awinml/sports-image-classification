...
- A fine-tuned **EfficientNetB3** model was used for generating the final predictions which yielded an an **Accuracy of 92.72%, F1-Score of 91.76% and an ROC-AUC Score of 96.92%.**
